...
class ScenarioTest:
    ...
    def __init__(self, ensemble_name: str, beta_index: int, cg_factor: int = 5, species: str = 'Fex',
        ...
        from ._scenario_test import find_frag_combos,  get_epi_c, domain_at_iteration, get_epicenter_payoff, \
            add_rank_to_dict
        ...
        self.find_frag_combos = find_frag_combos
    ...
    def find_all_payoffs(self, plot_check: bool = False) -> Tuple[dict, int]:
        ...
        for i, epi_c in enumerate(epi_centers):
            ...
            containment_combos = self.find_frag_combos(np.copy(self.R0_domain), self.fragmented_domain, self.iterations,
                                                       epi_c)
