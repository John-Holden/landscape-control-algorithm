...
def run_scenario_test():
    scenario_test = ScenarioTest('landscape_control_package_2021-07-10_ga-phi1', beta_index=9,
                                 iterations=10, cg_factor=3)
...
if __name__ == '__main__':
    if 'HPC_MODE' in os.environ:
        ...
        run_scenario_test_over_beta('landscape_control_package_2021-07-10_ga-phi1', sys.argv[1])
