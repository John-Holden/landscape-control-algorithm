...
def get_size_distributions_vs_beta(ens_name: str, cg_factor: int, plot_raw_map: bool = False, plot_clusters: bool = False, ranks : int =10) \
        -> np.ndarray:
    """
    Return
    :param ens_name:
...
if __name__ == '__main__':
    get_size_distributions_vs_beta('landscape_control_package_adb_ga_phi2', cg_factor=5)